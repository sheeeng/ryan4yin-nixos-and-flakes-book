...
- NixOS:
  [nixpkgs/nixos/modules](https://github.com/NixOS/nixpkgs/tree/nixos-26.05/nixos/modules), 我们在
  <https://search.nixos.org/options> 中能看到的所有 NixOS options 都是在这里定义的。
- Home Manager:
  [home-manager/modules](https://github.com/nix-community/home-manager/blob/release-26.05/modules): 可在
